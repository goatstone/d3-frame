import elementData from '../component/bar-chart/element-data'

describe('element data', () => {
    test('should return an array', () => {
        const returnValue = elementData([])
    ...
    test('should contain elements', () => {
        ...
        xScale.bandwidth = () => 2
        const returnValue = elementData([['A', 0.1]], xScale, () => 1, 100)
    ...
    test('containing elements should have specific properties', () => {
        ...
        xScale.bandwidth = () => 2
        const returnValue = elementData([['A', 1.0]], xScale, () => 1, 100)
